...
export class VehicleDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('maxVehicleApp.vehicle.delete.question'));
...
export default class VehicleComponentsPage {
  ...
  async deleteVehicle() {
    ...
    expect(await vehicleDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/maxVehicleApp.vehicle.delete.question/);
