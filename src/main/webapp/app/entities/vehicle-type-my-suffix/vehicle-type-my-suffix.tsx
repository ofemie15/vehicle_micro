  ...
  return (
    <div>
      <h2 id="vehicle-type-my-suffix-heading" data-cy="VehicleTypeHeading">
        <Translate contentKey="maxVehicleApp.vehicleType.home.title">Vehicle Types</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="maxVehicleApp.vehicleType.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="maxVehicleApp.vehicleType.home.createLabel">Create new Vehicle Type</Translate>
          </Link>
        </div>
      </h2>
        ...
        {vehicleTypeList && vehicleTypeList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="maxVehicleApp.vehicleType.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="maxVehicleApp.vehicleType.home.notFound">No Vehicle Types found</Translate>
            </div>
          )
        )}
      </div>
